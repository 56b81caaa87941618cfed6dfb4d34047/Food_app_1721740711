...
*/
Vue.component("simple_footer_component_1721740712", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Revolutionizing the food industry with innovative technology solutions. Stay ahead of the curve with our cutting-edge apps and platforms designed to streamline operations, enhance food safety, and create a more sustainable future for the food sector.
                    </div>
                </div>
            </div>
        </footer> 
